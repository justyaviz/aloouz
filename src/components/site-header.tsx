...
const topLinks = [
  ...
  { href: "/blog", label: "Mediablog", pill: true },
...
const catalogGroups = [
  ...
  },
  {
    ...
    links: [
      { href: "/#editorial", label: "Mediablog" },
      { href: "/#delivery", label: "Yetkazib berish" },
      { href: "/#about", label: "Biz haqimizda" },
              ...
              {topLinks.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    item.pill &&
                      "rounded-full bg-[#143d78] px-3 py-1.5 font-semibold text-white hover:text-white",
                  )}
                >
                  {item.label}
                </Link>
          ...
          <div className="shell grid gap-4 py-4 xl:grid-cols-[220px_minmax(0,1fr)_420px] xl:items-center">
            ...
            <form action="/catalog" className="flex items-center gap-3">
              <button
                ...
                className={cn(
                  "inline-flex h-12 items-center justify-center gap-2 rounded-[18px] px-6 text-sm font-semibold text-white shadow-[0_14px_28px_rgba(254,102,0,0.24)] transition",
                  catalogMenuOpen ? "bg-[#d74c00]" : "bg-support hover:bg-[#e45d07]",
                )}
              >
                <MenuIcon className="h-5 w-5" />
                Katalog
