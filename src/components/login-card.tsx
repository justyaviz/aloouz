...
export function LoginCard({ onClose, className }: LoginCardProps) {
  ...
  return (
    <div
      className={cn(
        "relative w-full max-w-[430px] rounded-[32px] border border-white/70 bg-white p-5 shadow-[0_30px_90px_rgba(13,31,55,0.18)] sm:p-8",
        className,
      )}
    >
      {onClose ? (
      ...
      <h2 className="mt-4 max-w-[12ch] font-display text-[2rem] font-semibold tracking-tight text-foreground sm:max-w-none sm:text-4xl">
        Kirish yoki ro&apos;yxatdan o&apos;tish
      </h2>
      <p className="mt-3 text-sm leading-7 text-muted">
        Telefon raqamingiz orqali himoyalangan session ochiladi va shaxsiy kabinetga kirish
        faollashadi.
      </p>
